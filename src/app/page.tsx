...
export default function Home() {
  ...
  const [tweets, setTweets] = useState<HormoziTweet[]>([]);
  ...
  const handleSearch = async () => {
    ...
    const results: HormoziTweet[] = await searchResponse.json();
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content={`AI-powered search and chat for Alex Hormozi's tweets.`}
        />
        ...
        <div className="flex-1 overflow-auto">
          <div className="mx-auto flex h-full w-full max-w-[750px] flex-col items-center px-3 pt-4 sm:pt-8">
            ...
            {loading ? (
              ...
              <div className="mt-6">
                ...
                <div className="mt-6 mb-16">
                  ...
                  {tweets.map((tweet, index) => (
                    <div
                      key={index}
                      className="mt-4 border border-zinc-600 rounded-lg p-4"
                    >
              ...
              <div className="mt-6 text-center text-lg">{`AI-powered search & chat for Alex Hormozi's tweets.`}</div>
            )}
          </div>
        </div>
        <Footer />
